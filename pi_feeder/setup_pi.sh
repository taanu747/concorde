...
echo "  python3 feeder.py --target-url https://[YOUR-RENDER-URL].onrender.com --secret [YOUR-SECRET]"
echo ""
echo "Option B) Run as background service (auto-starts on boot):"
echo "  1. Edit concorde-feeder.service to set your RENDER_URL and FEEDER_SECRET"
