...
from ai.copilot import process_ai_query, safe_round
...
def ai_copilot_query():
    ...
    try:
        ...
        print(f"AI Co-Pilot route exception: {e}")
        return jsonify({
            "type": "explanation",
            "text": f"Sorry, I had trouble parsing that query. Try asking <b>\"What is a Jetway?\"</b> or select an aircraft and tap <b>🤖 Explain Flight Intent</b>."
        })
